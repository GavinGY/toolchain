...
enum opt_code
{
  ...
  OPT_fvect_cost_model_ = 984,               /* -fvect-cost-model= */
  ...
  OPT_mabi_ = 1043,                          /* -mabi= */
  OPT_mabicalls = 1044,                      /* -mabicalls */
  OPT_mandroid = 1045,                       /* -mandroid */
  OPT_march_ = 1046,                         /* -march= */
  OPT_mbionic = 1047,                        /* -mbionic */
  OPT_mbranch_cost_ = 1048,                  /* -mbranch-cost= */
  OPT_mbranch_likely = 1049,                 /* -mbranch-likely */
  OPT_mcheck_zero_division = 1050,           /* -mcheck-zero-division */
  OPT_mcode_readable_ = 1051,                /* -mcode-readable= */
  OPT_mdebug = 1052,                         /* -mdebug */
  OPT_mdebugd = 1053,                        /* -mdebugd */
  OPT_mdivide_breaks = 1054,                 /* -mdivide-breaks */
  OPT_mdivide_traps = 1055,                  /* -mdivide-traps */
  OPT_mdmx = 1056,                           /* -mdmx */
  OPT_mdouble_float = 1057,                  /* -mdouble-float */
  OPT_mdsp = 1058,                           /* -mdsp */
  OPT_mdspr2 = 1059,                         /* -mdspr2 */
  OPT_meb = 1060,                            /* -meb */
  OPT_mel = 1061,                            /* -mel */
  OPT_membedded_data = 1062,                 /* -membedded-data */
  OPT_mexplicit_relocs = 1063,               /* -mexplicit-relocs */
  OPT_mextern_sdata = 1064,                  /* -mextern-sdata */
  OPT_mfix_24k = 1065,                       /* -mfix-24k */
  OPT_mfix_r10000 = 1066,                    /* -mfix-r10000 */
  OPT_mfix_r4000 = 1067,                     /* -mfix-r4000 */
  OPT_mfix_r4400 = 1068,                     /* -mfix-r4400 */
  OPT_mfix_sb1 = 1069,                       /* -mfix-sb1 */
  OPT_mfix_vr4120 = 1070,                    /* -mfix-vr4120 */
  OPT_mfix_vr4130 = 1071,                    /* -mfix-vr4130 */
  OPT_mfix4300 = 1072,                       /* -mfix4300 */
  OPT_mflip_mips16 = 1073,                   /* -mflip-mips16 */
  OPT_mflush_func_ = 1074,                   /* -mflush-func= */
  OPT_mfp_exceptions = 1075,                 /* -mfp-exceptions */
  OPT_mfp32 = 1076,                          /* -mfp32 */
  OPT_mfp64 = 1077,                          /* -mfp64 */
  OPT_mfused_madd = 1078,                    /* -mfused-madd */
  OPT_mglibc = 1079,                         /* -mglibc */
  OPT_mgp32 = 1080,                          /* -mgp32 */
  OPT_mgp64 = 1081,                          /* -mgp64 */
  OPT_mgpopt = 1082,                         /* -mgpopt */
  OPT_mhard_float = 1083,                    /* -mhard-float */
  OPT_minterlink_mips16 = 1084,              /* -minterlink-mips16 */
  OPT_mips = 1085,                           /* -mips */
  OPT_mips16 = 1086,                         /* -mips16 */
  OPT_mips3d = 1087,                         /* -mips3d */
  OPT_mllsc = 1088,                          /* -mllsc */
  OPT_mlocal_sdata = 1089,                   /* -mlocal-sdata */
  OPT_mlong_calls = 1090,                    /* -mlong-calls */
  OPT_mlong32 = 1091,                        /* -mlong32 */
  OPT_mlong64 = 1092,                        /* -mlong64 */
  OPT_mmad = 1093,                           /* -mmad */
  OPT_mmcount_ra_address = 1094,             /* -mmcount-ra-address */
  OPT_mmcu = 1095,                           /* -mmcu */
  OPT_mmemcpy = 1096,                        /* -mmemcpy */
  OPT_mmt = 1097,                            /* -mmt */
