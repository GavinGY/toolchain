...
OUTPUT_ARCH(mips)
ENTRY(__start)
SEARCH_DIR("/opt/toolchains/stbgcc-4.8-1.1/mips-linux-gnu/lib32"); SEARCH_DIR("=/usr/local/lib32"); SEARCH_DIR("=/lib32"); SEARCH_DIR("=/usr/lib32"); SEARCH_DIR("=/usr/local/lib"); SEARCH_DIR("=/lib"); SEARCH_DIR("=/usr/lib");
SECTIONS
{
